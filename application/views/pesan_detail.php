...
<div data-page="pesan-detail" class="page">
  <div class="navbar">
  ...
  <div class="page-content messages-content">
    <div class="messages messages-auto-layout">
      <div class="message message-sent message-with-avatar">
        ...
        <div style="background-image:url('timthumb.php?src=<?php echo(base_url()) ?>photo_profil/buyer2.jpg&w=50&h=50')" class="message-avatar"></div>
      </div>
      <div class="message message-sent message-with-avatar">
      ...
      <div class="message message-received message-with-avatar">
        ...
        <div style="background-image:url('timthumb.php?src=<?php echo(base_url()) ?>photo_profil/buyer1.jpg&w=50&h=50')" class="message-avatar"></div>
      </div>
      <div class="message message-received message-with-avatar">
      ...
      <div class="message message-sent message-pic message-with-avatar">
        <div class="message-text"><img src="timthumb.php?src=<?php echo(base_url()) ?>assets/img/dummy/padi1.jpg&w=200"/>
          <div class="message-date">Feb 13, 16:10</div>
        </div>
        <div style="background-image:url('timthumb.php?src=<?php echo(base_url()) ?>photo_profil/buyer2.jpg&w=50&h=50')" class="message-avatar"></div>
      </div>
